  ...
  return (
    ...
    <div className="px-0 tablet:px-8">
      ...
      <div className="mt-4 md:mt-8 md:px-4 px-2">
        <p className="flex gap-2 text-primary-main text-xl font-[500] cursor-pointer" onClick={() => setOpenModal(true)}> 
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M14.5598 20.94C13.1598 22.34 10.8598 22.34 9.44978 20.94L3.05977 14.55C1.65977 13.15 1.65977 10.85 3.05977 9.44001L9.44978 3.05C10.8498 1.65 13.1498 1.65 14.5598 3.05L20.9498 9.44001C22.3498 10.85 22.3498 13.15 20.9498 14.55L14.5598 20.94Z" stroke="#157B96" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.25 6.25L17.75 17.75" stroke="#157B96" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M17.75 6.25L6.25 17.75" stroke="#157B96" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M5 10V13C5 13.2761 5.22386 13.5 5.5 13.5H6H7" stroke="#157B96" strokeLinecap="round"/>
